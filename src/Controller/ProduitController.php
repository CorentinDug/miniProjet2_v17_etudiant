...
class ProduitController implements ControllerProviderInterface
{
    ...
    public function validFormAddProduit(Application $app, Request $req) {
        if (isset($_POST['nom']) && isset($_POST['typeProduit_id']) and isset($_POST['nom'])) {
            $donnees = [
            ...
            if ( !in_array($extension_upload,$extensions_valides) ) $erreurs['photo'] = "Extension incorrect : il faut soit jpg, jpeg, gif, png";
